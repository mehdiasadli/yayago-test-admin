...
export function CreateVehicleForm({ className, ...props }: React.ComponentProps<'form'>) {
  const router = useRouter();
  const createVehicleMutation = useCreateVehicleMutation();

  const form = useForm<CreateVehicleRequestSchemaType>({
  ...
  const onSubmit = async (data: CreateVehicleRequestSchemaType) => {
    try {
      const result = await createVehicleMutation.mutateAsync(data);
      toast.success('Vehicle created successfully!');
      router.push(`/vehicles/${result.id}/edit/images`);
    } catch (error) {
            ...
            <Controller
              ...
              render={({ field }) => (
                <Field>
                  ...
                  <Input id={field.name} placeholder='e.g., Toyota, BMW, Tesla' {...field} />
                  <FieldError
                    errors={
            ...
            <Controller
              ...
              render={({ field }) => (
                <Field>
                  ...
                  <Input id={field.name} placeholder='e.g., Camry, X5, Model 3' {...field} />
                  <FieldError
                    errors={
            ...
            <Controller
              ...
              render={({ field }) => (
                <Field>
                  ...
                  <Input id={field.name} placeholder='e.g., Black, White, Red' {...field} />
                  <FieldError
                    errors={
            ...
            <Controller
              ...
              render={({ field }) => (
                <Field>
                  ...
                  <Input id={field.name} placeholder='e.g., 2.0L, 3.5L' {...field} />
                  <FieldError
                    errors={
